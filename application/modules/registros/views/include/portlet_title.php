<div class="portlet-title">
    ...
    <?php if($this->uri->segment(2)  == 'view' AND $rol == 4): ?>
        ...
        <a id="0" data-campaign="<?= $getRegistro->getCampaign()->getId() ?>" target="_blank" data-toggle="modal" data-target="#modalSendInfo" class="btn green template" type="button"><i class="fa fa-envelope-o"></i> Enviar info</a>
